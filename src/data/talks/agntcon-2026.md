...
[Agent Router](https://theagentrouter.ai/) — newly donated to the Agentic AI Foundation, with a 1.0 GA release and production deployments at scale — collapses all of it into a single integration: every model, every tool, one declarative API.
